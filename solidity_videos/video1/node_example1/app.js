...
global.acct_acct1 = web3.eth.accounts[1];
global.acct_acct2 = web3.eth.accounts[2];
...
global.PayExample = global.interface.deployContract('contracts/PayExample', {from: acct_owner});
